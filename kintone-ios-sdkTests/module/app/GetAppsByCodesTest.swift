...
class GetAppsByCodesTest: XCTestCase {
    ...
    private let APP_CODES = ["GetAppTest"]
    ...
    func testGetAppsByCodesSuccess() {
        ...
        XCTAssertNoThrow(appsResponse = try self.app?.getAppsByCodes(self.APP_CODES, self.OFFSET, self.LIMIT))
    ...
    func testGetAppsByCodesFailWhenLimitGreaterThanMaxValue() {
        ...
        XCTAssertThrowsError(try self.app?.getAppsByCodes(self.APP_CODES, self.OFFSET, limit)){
